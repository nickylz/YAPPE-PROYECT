...
import MisConsultas from "../componentes/MisConsultas";
...
export default function Perfil() {
  ...
  if (cargandoAuth || !usuarioActual) {
    return (
      <div className="min-h-screen bg-[#fcfaff] flex flex-col items-center justify-center">
        ...
        <p className="text-[#3b0f52] font-black uppercase italic text-[10px] tracking-[0.3em] animate-pulse">
          Cargando...
        </p>
      </div>
    );
  ...
  const activeContent = menuConfig.find((tab) => tab.id === activeTab)
    ?.component || <PerfilForm />;
          ...
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <div className="flex flex-col items-center">
              <p className="text-white/90 font-medium text-base md:text-xl">
                Hola,{" "}
                <span className="text-white font-black text-2xl md:text-5xl underline decoration-[#00d1c4] decoration-4 underline-offset-4">
